...
- Added deterministic vertical graph auto-layout for the complete story or a
  ...
  cycle and disconnected-component handling, measured variable-height cards,
  crossing- and link-span-aware layer ordering with local option transpositions,
  parent-centered option bundles, spaced grouped trigger markers, separated routing
  lanes that avoid unrelated trigger markers, and fixed bottom-output/top-input
  interaction arrow routing.
