...
This folder records accepted architecture and product-shaping decisions.

## Decisions

- [ADR-001 - Minimal MVP](ADR-001-minimal-mvp.md)
...
Add or update an ADR when a decision changes the product scope, architecture,
domain model, persistence strategy, test strategy, or long-term technical
direction.
