...
5. [Architecture](architecture.md): technical organization of the monorepo.
6. [Design principles](design-principles.md): UX and technical principles.
7. [Test scenarios](test-scenarios.md): test scenarios to maintain.
8. [Roadmap](roadmap.md): planned progression after the MVP.
